        ...
        <div class="row">
            <div class="col">
				...
				<section class="mt-10" style="text-align:center;">
				  <!-- Section heading -->
				  <h2 class="h1-responsive font-weight-bold text-center mt-5">Franchise Stores</h2>
              ...
              <div class="modal-body mx-3">
                ...
                <div class="md-form">
	              <div class="form-check">
				    ...
				    <input type="radio" class="form-check-input" id="materialChecked2" name="storeType" checked value="franchise">
