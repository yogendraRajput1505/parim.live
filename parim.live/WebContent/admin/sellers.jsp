        ...
        <div class="row">
            <div class="col">
				...
				<section class="mt-10" style="text-align:center;">
				  <!-- Section heading -->
				  <h2 class="h1-responsive font-weight-bold text-center mt-5">Sellers</h2>
				  ...
				  try{
					  ...
					  userQuery.setParameter("wholesaler","seller");
              ...
              <div class="modal-body mx-3">
                ...
                <div class="md-form">
	              <div class="form-check">
	              	Store Type<br>
				    <input type="radio" class="form-check-input" id="materialChecked1" name="storeType" value="wholesaler">
				    ...
				    <input type="radio" class="form-check-input" id="materialChecked3" name="storeType" checked value="seller">
