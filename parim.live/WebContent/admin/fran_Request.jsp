...
<body class="fixed-sn pink-skin light-theme-background">
	...
	<section class="my-5">
	  <div class="container ">
  		<div class="row">
  			<div class="col-md-12">
  				<center><h2>Request For Franchise</h2></center>
  			</div>
  		</div>
			...
			<div class="col-md bg-white border mt-4 border-rounded" >
				<table id="dtMaterialDesignExample" class="table table-responsive" cellspacing="0" width="100%">
				  ...
				  Session ses =null;					  
					  ...
					  Query userQuery  = ses.createQuery("from "+FranchiseRequest.class.getName()+" c where requestType = :requestType");
					  userQuery.setParameter("requestType","franchise");
